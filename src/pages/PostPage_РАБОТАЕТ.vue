              ...
              >
                ...
                <q-list>
                  ...
                  >
                    ...
                    <q-item-section>
                      <q-item-label class="text-body2">{{option.label}}</q-item-label>
                      <q-item-label v-if="option.name !== 'specific'" caption>
                        {{ date.formatDate(option.value.from, "DD MMMM 'YY", { months: allMonths }) }}
                        —
                        {{ date.formatDate(option.value.to, "DD MMMM 'YY", { months: allMonths }) }}
                      </q-item-label>
                      <q-item-label v-if="option.name === 'specific'">
                        ...
                        <div class="row q-gutter-sm items-center">
                          <div>
                            ...
                            <q-date
                              ...
                              :disable="dateSelected.name !== 'specific'"
                              @click="dateSelected = dateOptions[2]"
                              minimal
                              flat
                            />
                          </div>
...
const currentDate = ref(date.formatDate(new Date(), 'YYYY-MM-DD HH:mm:ss'))

const currentDateWeek = computed(() => date.formatDate(date.subtractFromDate(currentDate.value, { days: 7 }), 'YYYY-MM-DD HH:mm:ss'))
const currentDateMonth = computed(() => date.formatDate(date.subtractFromDate(currentDate.value, { days: 30 }), 'YYYY-MM-DD HH:mm:ss'))
...
//
onMounted(() => {
  // postsStore.currentDate = date.formatDate(new Date(), 'YYYY-MM-DD HH:mm:ss')
  getChartData()
})
...
onBeforeRouteUpdate((to, from) => {
  ...
  currentDate.value = date.formatDate(new Date(), 'YYYY-MM-DD HH:mm:ss')
  getChartData()
})
